...
audio-hal := hardware/qcom/caf-4.14/audio
display-hal := hardware/qcom/caf-4.14/display
gps-hal := hardware/qcom/caf-4.14/gps
ipa-hal := hardware/qcom/caf-4.14/data-ipa-cfg-mgr

QCOM_MEDIA_ROOT := hardware/qcom/caf-4.14/media
